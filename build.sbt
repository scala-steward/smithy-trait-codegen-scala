...
lazy val core = project
  .settings(
    ...
    libraryDependencies ++= Seq(
      "software.amazon.smithy" % "smithy-trait-codegen" % "1.72.0",
      "software.amazon.smithy" % "smithy-model" % "1.72.0",
      "software.amazon.smithy" % "smithy-syntax" % "1.72.0",
      "software.amazon.smithy" % "smithy-docgen" % "1.72.0",
...
lazy val sbtPluginSmithy4s = project
  ...
  .settings(
    ...
    libraryDependencies += Defaults.sbtPluginExtra(
      "com.disneystreaming.smithy4s" % "smithy4s-sbt-codegen" % "0.19.10",
